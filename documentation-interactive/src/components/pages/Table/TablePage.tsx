...
function TablePage(props: any) {
  return (
    <Page.Documentation {...props}>
      <Documentation.Section title={pageNames.Table} />

      <Documentation.Section subtitle="Import">
        <Code.Sample>{`import { Table } from "${packageName}";`}</Code.Sample>
      </Documentation.Section>
      <Documentation.Section subtitle="Basic">
        <Code.Editor
          scope={{ Table, useState, Pressable, View, MaterialCommunityIcons }}
        >
          {code}
        </Code.Editor>
      </Documentation.Section>

      <Documentation.Section subtitle="Extended Rows">
        <Code.Editor
          scope={{ Table, useState, Pressable, View, MaterialCommunityIcons }}
        >
          {extendedRowsCode}
      ...
      <Documentation.PropsSection
        rows={[
          [
            ...
            "boolean",
            "true",
            "Enable zebra-striping to any table row within table body",
          ],
          [
            "border",
            "boolean",
          ...
          [
            ...
            "boolean",
            "true",
            "Enable hovering on table rows within table body",
          ],
        ]}
      >
