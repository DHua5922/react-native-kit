...
function CalendarLeftPage() {
  return (
    <Page.Documentation>
      <Documentation.Section title={pageNames.CalendarLeft} />
      ...
      <Documentation.PropsSection
        rows={[
          [
            ...
            "",
            "Callback fired when pressing button to go to previous month.",
          ],
        ]}
      >
...
export default CalendarLeftPage;
