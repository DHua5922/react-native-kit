...
function AccordionTogglePage(props: any) {
  return (
    <Page.Documentation {...props}>
      <Documentation.Section title={pageNames.AccordionToggle}>
        AntDesign icon for indicating if the accordion has expanded or
        collapsed.
...
export default AccordionTogglePage;
